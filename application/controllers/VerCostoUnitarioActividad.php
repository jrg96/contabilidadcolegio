<?php
class VerCostoUnitarioActividad extends CI_Controller {
    ...
    public function __construct()
    {
		...
		$this->load->model('CostoUnitarioActividad_model');
    ...
    public function index()
    {
		...
		// Paso 5: empezar a calcular el costo unitario de actividades
		$costo_actividad = new CostoUnitarioActividad_model();
		$costo_actividad->set_actividades_finales($reparto_terciario->obtener_actividades_finales());
		$costo_actividad->calcular_costos_unitarios();
		$info_a_desplegar = $costo_actividad->obtener_info_a_desplegar();
        ...
        $this->smarty->view('ver_costo_unitario_actividades.php');
    }
}