<?php
/* Smarty version 3.1.30, created on 2017-11-27 02:23:53
  from "H:\tpi\USBWebserver v8.6\root\sic115\application\views\templates\crear_consumidor_costo.php" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a1b7739ccb733_13780970',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3b30c42d27c551e8da22ea6e09a18c650eacc7bc' => 
    array (
      0 => 'H:\\tpi\\USBWebserver v8.6\\root\\sic115\\application\\views\\templates\\crear_consumidor_costo.php',
      1 => 1511749432,
      2 => 'file',
    ),
  ),
...
function content_5a1b7739ccb733_13780970 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
    <head>
...
css/bootstrap.min.css" rel="stylesheet">
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="/sic115/index.php/crearconsumidorcosto/procesar" method="POST">
                <div class="panel panel-primary">
                    <div class="panel-heading">Crear consumidor costo</div>
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="usr">Nombre consumidor costo:</label>
                            <input type="text" class="form-control" id="nombre_consumidor_costo" name="nombre_consumidor_costo">
                        </div>
                    </div>
                </div>
...
:</label>
                            <input type="text" class="form-control" id="inductor_<?php echo $_smarty_tpl->tpl_vars['inductor']->value['id_inductor_costo'];?>
" name="inductor_<?php echo $_smarty_tpl->tpl_vars['inductor']->value['id_inductor_costo'];?>
">
                        </div>
						<?php
}
