                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                {foreach item=consumidor from=$consumidor_costo}
                                <tr>
                                    <th><center>{$consumidor.nombre_consumidor_costo}</center></th>
                                    <th><center><a href="/sic115/index.php/modificarconsumidorcosto/index/{$consumidor.id_consumidor_costo}">Actualizar</a></center></th>
                                    <th><center><a href="/sic115/index.php/vertransaccionescuenta/index/{$cuenta.id_cuenta_interno}">Eliminar</a></center></th>
                                </tr>
                                {/foreach}
                            </tbody>
                        </table>
