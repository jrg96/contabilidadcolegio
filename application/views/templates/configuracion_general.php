        ...
        <div class="container">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <input type="text" class="form-control" id="utilidades_retenidas" name="utilidades_retenidas" value="{$perc_utilidad_retenida}">
                    
                    <br />
                    
                    <label for="usr">Duracion del periodo contable (meses):</label>
                    <input type="text" class="form-control" id="periodo_contable" name="periodo_contable" value="{$longitud_periodo_contable}">
