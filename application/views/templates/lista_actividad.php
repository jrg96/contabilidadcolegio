                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th><center>{$actividad.descripcion_actividad}</center></th>
									<th><center>{$actividad.nombre_centro_costo}</center></th>
                                    <th><center><a href="/sic115/index.php/modificaractividad/index/{$actividad.id_actividad}">Actualizar</a></center></th>
                                    <th><center><a href="/sic115/index.php/eliminaractividad/index/{$actividad.id_actividad}">Eliminar</a></center></th>
                                </tr>
                                {/foreach}
                            </tbody>
                        </table>
