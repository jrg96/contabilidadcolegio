    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="/sic115/index.php/modificarcriteriorepartoprimario/procesar" method="POST">
				<input type="hidden" name="id_criterio_reparto_primario" id="id_criterio_reparto_primario" value="{$criterio_reparto_primario.id_criterio_reparto_primario}" />
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            {foreach item=cuenta from=$cuentas}
								{if $criterio_reparto_primario.id_cuenta_interno eq $cuenta.id_cuenta_interno}
                                <option value="{$cuenta.id_cuenta_interno}" selected>{$cuenta.id_clase_cuenta}.{$cuenta.id_grupo_cuenta}.{$cuenta.id_cuenta_mayor}.{$cuenta.id_cuenta} {$cuenta.nombre_cuenta} {$cuenta.abreviatura_clase_cuenta}</option>
								{else}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombre_criterio_reparto_primario" name="nombre_criterio_reparto_primario" value="{$criterio_reparto_primario.nombre_criterio_reparto_primario}">
                        </div>
						
						<div class="form-group">
                            <label for="usr">Descripcion de criterio de reparto primario:</label>
                            <input type="text" class="form-control" id="desc_criterio_reparto_primario" name="desc_criterio_reparto_primario" value="{$criterio_reparto_primario.desc_criterio_reparto_primario}">
                        </div>
						
						<div class="form-group">
                            <label for="usr">Unidad en la que estarán expresados los valores:</label>
                            <input type="text" class="form-control" id="unidad_reparto" name="unidad_reparto" value="{$criterio_reparto_primario.unidad_reparto}">
                        </div>
                    </div>
                </div>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<div class="form-group">
                            ...
                            <input type="text" class="form-control" id="unidad_reparto_{$centro.id_unidad_reparto_primario}" name="unidad_reparto_{$centro.id_unidad_reparto_primario}" value="{$centro.valor_unidad}">
                        </div>
						{/foreach}
