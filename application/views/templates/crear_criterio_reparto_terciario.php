...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
			...
			{/if}
				<input type="hidden" name="id_actividad_auxiliar" id="id_actividad_auxiliar" value="{$actividad.id_actividad}" />
				<input type="hidden" name="es_nuevo_registro" id="es_nuevo_registro" value="{$es_nuevo_registro}" />
				<input type="hidden" name="id_criterio_reparto_terciario" id="id_criterio_reparto_terciario" value="{$criterio_reparto_terciario.id_criterio_reparto_terciario}" />
                <div class="panel panel-primary">
                    <div class="panel-heading">Crear criterio de reparto terciario {$actividad.nombre_actividad}</div>
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="usr">Nombre de criterio de reparto terciario:</label>
                            <input type="text" class="form-control" id="nombre_criterio_reparto_terciario" name="nombre_criterio_reparto_terciario" value="{$criterio_reparto_terciario.nombre_criterio_reparto_terciario}">
                        </div>
						
						<div class="form-group">
                            <label for="usr">Descripcion de criterio de reparto secundario:</label>
                            <input type="text" class="form-control" id="desc_criterio_reparto_terciario" name="desc_criterio_reparto_terciario" value="{$criterio_reparto_terciario.desc_criterio_reparto_terciario}">
                        </div>
						
						<div class="form-group">
                            <label for="usr">Unidad en la que estarán expresados los valores:</label>
                            <input type="text" class="form-control" id="unidad_reparto" name="unidad_reparto" value="{$criterio_reparto_terciario.unidad_reparto}">
                        </div>
                    </div>
                </div>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							{else}
							<input type="text" class="form-control" id="unidad_reparto_{$actividad.id_unidad_reparto_terciario}" name="unidad_reparto_{$actividad.id_unidad_reparto_terciario}" value="{$actividad.valor_unidad}">
							{/if}
                        </div>
						{/foreach}
